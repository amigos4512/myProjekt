...
export const updatePreviewImg = (
  previewImgFile,
  previewImgSrc,
  previewImgAlt,
) =>
  createAction(UPDATE_PREVIEWIMG, {
    previewImgFile,
    previewImgSrc,
    previewImgAlt,
  });
...
export const updateCategory = category =>
  createAction(UPDATE_CATEGORY, category);
...
export const updateShortDescr = shortDescr =>
  createAction(UPDATE_SHORTDESCR, shortDescr);

export const reloadCommodityData = () => createAction(RESET_COMMODITY_DATA);

export const updateReviews = newReview =>
  createAction(UPDATE_REVIEWS, newReview);

export const updateRating = (newRating, oldRating = null) =>
  createAction(UPDATE_RATING, { newRating, oldRating });

export const removeReview = reviewForRemove =>
  createAction(REMOVE_REVIEW, reviewForRemove);

const fetchCommoditySuccuess = data =>
  createAction(FETCH_COMMODITY_SUCCUESS, data);
...
const getSimilarGoods = similarGoods =>
  createAction(GET_SIMILAR_GOODS, similarGoods);
